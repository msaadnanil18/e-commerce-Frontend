  ...
  const handelOnSaveOrder = () => {
    ...
    ServiceErrorManager(
      ...
      if (response?.data?.orderId) {
        router.push(`/order-confirmation?order-id=${response?.data?.orderId}`);
      }
      ...
      <YStack space='$4'>
            ...
            >
                  ...
                  <XStack space='$2'>
                    <YStack flex={1} space='$2'>
                      <Input
                        ...
                        keyboardType='numeric'
                        maxLength={5}
                        onChangeText={(value) => validateCard('expiry', value)}
                      />
                      {/* {cardErrors.expiry && (
              ...
              >
                <XStack alignItems='center' space='$3'>
                  ...
                  <YStack flex={1}>
                    <Text
                      fontWeight={paymentMethod === 'paytm' ? 'bold' : 'normal'}
                    >
                      Paytm
                    </Text>
                    <Text fontSize='$2' opacity={0.7}>
                ...
                <Card padding='$3' marginLeft='$6' backgroundColor='$yellow2'>
                  <XStack alignItems='center' space='$2'>
                    ...
                    <Text fontSize='$3' color='$yellow11'>
                      ...
                      collect <PriceFormatter value={totalAmount} /> at your
                      doorstep.
                    </Text>
                  </XStack>
                </Card>
        ...
        <YStack flex={1} minWidth={320} space='$4'>
          ...
          <PulseButton
            ...
            icon={submitLoading ? <Spinner color='white' /> : <FiCheckCircle />}
            ...
            <Card padding='$3' backgroundColor='$blue2'>
              <XStack alignItems='center' space='$2'>
                ...
                <Text fontSize='$3' color='$blue11'>
                  Cash on Delivery: No online payment required. Pay directly to
